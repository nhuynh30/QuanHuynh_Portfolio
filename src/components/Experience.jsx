...
const jobs = [
  ...
  {
    id: 2,
    role: 'University Learning Assistant',
    company: 'George Mason University',
    type: 'Part-time',
    dates: 'Aug 2025 – Dec 2025 · 5 mos',
    location: 'Fairfax, Virginia · On-site',
    desc: 'Assisted students during CS 112 Python labs by explaining programming concepts, debugging code, and guiding students through lab exercises.',
    tags: ['Python', 'Teaching', 'Debugging', 'Mentorship', 'Communication'],
    colorClass: 'logo-gm',
    shadowClass: 'logo-gm-item',
    initials: 'GM',
    logo: '/assets/schoologo.png',
  },
  {
    id: 3,
    role: 'Barista',
