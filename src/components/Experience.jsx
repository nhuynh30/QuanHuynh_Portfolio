...
const jobs = [
  {
    ...
    desc: 'Developing AI-powered software solutions as part of the Deepiri team. Contributing to full-stack development, building intelligent features, and collaborating with engineers to ship production-ready code.',
    tags: ['AI / ML', 'Full Stack', 'React', 'Python', 'Teamwork'],
    colorClass: 'logo-dp',
